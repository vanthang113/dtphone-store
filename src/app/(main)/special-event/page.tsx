...
export default function MenuSlidePage() {
  ...
  return (
    <div className="mt-12">
      {/* Menu Slide Section */}
      <div className="fixed top-[64px] left-0 w-full bg-[#FFCCCC] text-white px-4 sm:px-6 lg:px-20 py-2 flex justify-around items-center z-40">
        <Button
      ...
      <div className="max-w-[1200px] px-2 mx-auto">
        ...
        <div className="shadow-xl mt-10 rounded-lg relative">
          ...
          >
            ...
            <div className="w-[1px] h-[60%] bg-gray-300 mx-2" />
        ...
        <div className="mt-10">
          <div className="flex flex-col items-center">
            <Image src="/images/Giam-gia.png" alt="Các nhóm hàng đang ưu đãi" width={700} height={70} className="mb-4" />
          </div>
          ...
          <div className="w-full h-auto flex flex-wrap gap-2 sm:gap-3 lg:gap-6 items-start">
            ...
            <div className="flex-1 min-w-[0] w-full grid grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3 lg:gap-6">
              {Array.from({ length: 6 }).map((_, idx) => (
                <Button
                  key={idx}
                  className="bg-transparent w-full max-w-[285px] h-full max-h-[222px] rounded-none p-0 overflow-hidden hover:cursor-pointer rounded-3xl shadow-xl hover:shadow-[0_8px_24px_rgba(0,0,0,0.3)] transition-shadow duration-[400ms] ease-in-out"
                >
                  <Image
                    src="/images/500k.png"
                    alt="Các nhóm hàng đang ưu đãi"
