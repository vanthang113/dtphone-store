...
export default function ProductDetail({ params }: Props) {
  ...
  const images = [
    ...
    { src: "/images/my_phone/New folder/dien-thoai-oppo-reno12-5g_5__5.webp", alt: "Product Image 7" },
    { src: "/images/my_phone/New folder/dien-thoai-zte-blade-a55_1.webp", alt: "Product Image 8" },
    { src: "/images/my_phone/New folder/group_1_7.webp", alt: "Product Image 9" },
  ];
  ...
  const colors = [
    {
      name: "Black Titanium",
      price: "20.990.000đ",
      imageSrc: "/images/my_phone/New folder/dien-thoai-meizu-mblu-21_4__2.webp",
      imageAlt: "Black Titanium",
    },
    {
      name: "White Titanium",
      price: "21.490.000đ",
      imageSrc: "/images/my_phone/New folder/dien-thoai-oppo-reno12-5g_5__5.webp",
      imageAlt: "White Titanium",
    },
    {
      name: "Blue Titanium",
      price: "21.990.000đ",
      imageSrc: "/images/my_phone/New folder/dien-thoai-nubia-z70s-ultra-5g_10_.webp",
      imageAlt: "Blue Titanium",
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "Chip A16 Bionic với 5 nhân CPU và 16 nhân Neural Engine, giúp xử lý đa nhiệm nhanh chóng và nâng cao hiệu suất đồ họa.",
    },
    {
      id: "feature-2",
      title: "Dung lượng",
