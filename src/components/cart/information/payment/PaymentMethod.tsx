import { ChevronRight, CreditCard, X, Truck, CreditCard as CardIcon, Smartphone, Building } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-black/50 z-99 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[80vh] overflow-hidden">
              ...
              {paymentMethods.map((method) => (
                <div
                  ...
                  className={`p-3 border rounded-lg cursor-pointer transition-all duration-200 hover:shadow-md ${
                    selectedPayment?.id === method.id ? 'border-red-500 bg-red-50' : 'border-gray-200 hover:border-red-300'
                  }`}
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      {method.discount && <div className="text-sm font-medium text-red-600 mt-1">{method.discount}</div>}
                    </div>
            ...
            <div className="p-4 border-t border-gray-200">
              <Button onClick={() => setIsDialogOpen(false)} className="w-full bg-[#00868B] hover:bg-[#00868B] text-white">
                Xác nhận
              </Button>
            </div>
          </div>
