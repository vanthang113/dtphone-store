...
export default function ProductCommitmentSection() {
  return (
    <div className="mt-4 sm:mt-5 md:mt-6">
      <h3 className="text-base sm:text-lg md:text-lg font-semibold text-black mb-2 sm:mb-3 md:mb-4">Cam kết sản phẩm</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
        <div className="flex flex-col p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-2xl space-y-1.5 sm:space-y-2">
          <div
            className="w-8 sm:w-10 h-8 sm:h-10 text-white font-bold text-xs sm:text-sm rounded-full px-2 text-center hover:brightness-110 transition flex flex-col items-center justify-center leading-tight"
            style={{ background: 'linear-gradient(0deg, #00868B, #00868B)' }}
          >
            <SmartphoneCharging />
          </div>
          <p className="text-xs sm:text-sm text-gray-800">Mới, đầy đủ phụ kiện từ nhà sản xuất</p>
        </div>
        <div className="flex flex-col p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-2xl space-y-1.5 sm:space-y-2">
          <div
            className="w-8 sm:w-10 h-8 sm:h-10 text-white font-bold text-xs sm:text-sm rounded-full px-2 text-center hover:brightness-110 transition flex flex-col items-center justify-center leading-tight"
        ...
        <div className="flex flex-col p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-2xl space-y-1.5 sm:space-y-2">
          <div
            className="w-8 sm:w-10 h-8 sm:h-10 text-white font-bold text-xs sm:text-sm rounded-full flex flex-col items-center justify-center"
            style={{ background: 'linear-gradient(0deg, #00868B, #00868B)' }}
          >
            <Tickets />
          </div>
