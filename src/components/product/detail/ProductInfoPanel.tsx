  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 bg-blue-50 border border-blue-800 rounded-2xl w-fit">
        <h3 className="text-black font-semibold mb-2">Giá sản phẩm</h3>
      ...
      {/* Product Versions */}
      <div>
        <h3 className="text-black font-semibold mb-2">Phiên bản</h3>
      ...
      {/* Product Colors */}
      <div>
        <h3 className="text-black font-semibold mb-2">Màu sắc</h3>
