...
export function PasswordCard() {
  ...
  const [lastUpdated, setLastUpdated] = React.useState("03/11/2024 16:42");
  ...
  return (
    <>
      ...
      {isDesktop ? (
        <EditFormSheet open={open} onOpenChange={setOpen} onSave={handleSave} />
      ) : (
        <EditFormDrawer open={open} onOpenChange={setOpen} onSave={handleSave} />
      )}
    </>
  );
}
