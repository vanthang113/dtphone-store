...
export function AddressForm({
  ...
  // dùng schema ở runtime để ESLint không báo "only used as type"
  void addressFormSchema;
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ví dụ: Nhà riêng, Văn phòng..." {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      <SelectItem value="pdk">Phường Đa Kao</SelectItem>
                      <SelectItem value="pbn">Phường Bến Nghé</SelectItem>
                      <SelectItem value="pbt">Phường Bến Thành</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
